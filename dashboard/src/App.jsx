...
export default function App() {
  ...
  // Initial fetch only — refresh is manual via the sidebar button
  useEffect(() => { fetchData(); }, []);
      ...
      <div className="cyber-main-viewport">
        ...
        {activeTab === 'settings' ? (
          <div style={{ padding: '4px 0' }}>
            <div style={{ fontFamily: 'var(--font-hud)', fontSize: '0.72rem', color: 'var(--text-secondary)', letterSpacing: '1.5px', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '10px' }}>
